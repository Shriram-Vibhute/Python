...
print(type('shrrjfgj'))  # prints the type of the string literal, which is <class 'str'>
...
f = {'Hello', 'World', 'Welcome'}  # a set object containing unique elements, order is not guaranteed
